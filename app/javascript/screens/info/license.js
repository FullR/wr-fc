        ...
        return (
            <div>
                <div style={contentStyle}>
                    <div style={headerStyle}>THE CRITICAL THINKING CO.&trade;</div>
                    <div style={headerStyle}>SOFTWARE LICENSE AGREEMENT</div>
                    <div style={headerStyle}>IMPORTANT—READ CAREFULLY</div>
                    <div style={paragraphStyle}>This is a legal agreement between you (a single entity, company, or educational institution) and The Critical Thinking Co.&trade; for the software accompanying this agreement, which includes computer Software and associated Documentation. By installing this Software on a computer, you agree to be bound by the terms of this agreement. If you do not agree to the terms of this agreement, promptly erase all copies of the software in your possession and return any Software packaging associated with this order within sixty (60) days of purchase to the place from which you obtained it for a full refund.</div>
                    <div style={paragraphStyle}>The Critical Thinking Co.&trade; hereby grants to you a non-exclusive license to use the software product identified above (the "Software") and the accompanying printed materials and User Manual (the "Documentation") on the terms set forth below.</div>
                    <div style={paragraphStyle}><span style={sectionTitleStyle}>1. GRANT OF LICENSE.</span> The Critical Thinking Co.&trade; grants you the right to install and use this Software Product, provided that this software will be installed only in the quantity and for the computer system(s) indicated (home-use or school/institution-use) at the time of your order for the Software.</div>
                    ...
                    <div style={paragraphStyle}><span style={sectionTitleStyle}>4. WARRANTIES.</span> The Critical Thinking Co.&trade; expressly disclaims any warranty for the Software Product. The Software and Documentation are provided "as is" without warranty of any kind, either expressed or implied, including, without limitation, the implied warranties or merchantability, fitness for a particular purpose, or non-infringement. The entire risk arising out of use or performance of the Software remains with you. If media within this package is defective, remove the software application from your device(s) and return any software packaging associated with this order to The Critical Thinking Co.&trade; within 60 days of the date of purchase, and they will replace it at no charge.</div>
