  ...
  return () => {
    return cordovaBuilder({
      ...
      preferences: [
        ...
        '<icon src="www/assets/images/icon.png" width="57" height="57" />',
        '<icon gap:platform="ios" src="www/assets/images/icon-small.png" width="29" height="29" />',
        '<icon gap:platform="ios" src="www/assets/images/icon-small_2x.png" width="58" height="58" />',
        '<icon gap:platform="ios" src="www/assets/images/icon-40.png" width="40" height="40" />',
        '<icon gap:platform="ios" src="www/assets/images/icon-40_2x.png" width="80" height="80" />',
        '<icon gap:platform="ios" src="www/assets/images/icon-50.png" width="50" height="50" />',
        '<icon gap:platform="ios" src="www/assets/images/icon-50_2x.png" width="100" height="100" />',
        '<icon gap:platform="ios" src="www/assets/images/icon.png" width="57" height="57" />',
        '<icon gap:platform="ios" src="www/assets/images/icon_2x.png" width="114" eight="114" />',
        '<icon gap:platform="ios" src="www/assets/images/icon-60.png" width="60" height="60" />',
        '<icon gap:platform="ios" src="www/assets/images/icon-60_2x.png" width="120" height="120" />',
        '<icon gap:platform="ios" src="www/assets/images/icon-60_3x.png" width="180" height="180" />',
        '<icon gap:platform="ios" src="www/assets/images/icon-72.png" width="72" height="72" />',
        '<icon gap:platform="ios" src="www/assets/images/icon-72_2x.png" width="144" height="144" />',
        '<icon gap:platform="ios" src="www/assets/images/icon-76.png" width="76" height="76" />',
        '<icon gap:platform="ios" src="www/assets/images/icon-76_2x.png" width="152" height="152" />',
